...
def build_route_vehicle_plan(*, route_id: str, route_length_km: float,
    ...
    rec = reconcile_route_periods(
        route_length_km=route_length_km, period_peak_flows=period_peak_flows,
    ...
    costs = aggregate_route_costs(
        vehicle_type=vehicle_type, annual_km=rec["annual_mileage_km"],
    ...
    return {
        "route_id": str(route_id), "route_length_km": float(route_length_km),
        ...
        "periods": rec["periods"], "costs": costs,
    }
