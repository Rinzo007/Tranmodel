"""Single source of truth for route operating economics.

This adapter delegates the physical operating calculation to vehicle_types and
keeps the economic aggregation in one place for vehicle selection and TNDP.
"""
...
def calculate_annual_route_economics(*, route_length_km: float, max_section_flow_pph: float,
                                     vehicle_type: str, speed_kmh: float = 18.0,
    ...
    op = calculate_route_operations(
        ...
        frequency_profile=frequency_profile or ((1,.8),(2,1),(7.5,.8),(3,1),(1.5,.8),(3,.5)),
    )
